---
name: CV DOCX to Markdown
description: Sync a Markdown CV from a DOCX source using the cv-docx-to-md skill with safe defaults.
argument-hint: DOCX path -> Markdown path (optional: selective|strict) (optional: contact-only|skills-only|career-only|full)
agent: agent
---

Use the [cv-docx-to-md skill](../../.claude/skills/cv-docx-to-md/SKILL.md) to synchronize a Markdown CV from a DOCX source.
